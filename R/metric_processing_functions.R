...
calc_iod_rate <-function(activity_by_type_clusters_stg1,metric24_processed){
  activity_by_type_clusters_stg2 <- activity_by_type_clusters_stg1 |>
    left_join(metric24_processed)|>
    rename(metric24a_num_total=started,
           metric24b_num_total=completed)|>
    mutate(metric2_rate=metric2_num_total/list_size_total,
           ...
           metric24a_rate=metric24a_num_total/metric1_total,
           metric24b_rate=metric24b_num_total/metric1_total,
           ...
           metric2_upper_ci=(metric2_num_total+(sqrt(metric2_num_total*1.96)))*(1/list_size_total),
           metric2_lower_ci=(metric2_num_total-(sqrt(metric2_num_total*1.96)))*(1/list_size_total),
           metric5_upper_ci=(metric5_num_total+(sqrt(metric5_num_total*1.96)))*(1/list_size_total),
           metric5_lower_ci=(metric5_num_total-(sqrt(metric5_num_total*1.96)))*(1/list_size_total),
           metric6_upper_ci=(metric6_total+(sqrt(metric6_total*1.96)))*(1/list_size_total),
           metric6_lower_ci=(metric6_total-(sqrt(metric6_total*1.96)))*(1/list_size_total),
           metric7_upper_ci=(metric7_total+(sqrt(metric7_total*1.96)))*(1/list_size_total),
           metric7_lower_ci=(metric7_total-(sqrt(metric7_total*1.96)))*(1/list_size_total),
           metric8_upper_ci=(metric8_total+(sqrt(metric8_total*1.96)))*(1/list_size_total),
           metric8_lower_ci=(metric8_total-(sqrt(metric8_total*1.96)))*(1/list_size_total),
           metric9_upper_ci=(metric9_total+(sqrt(metric9_total*1.96)))*(1/list_size_total),
           metric9_lower_ci=(metric9_total-(sqrt(metric9_total*1.96)))*(1/list_size_total),
           metric11_upper_ci=(metric11_num_total+(sqrt(metric11_num_total*1.96)))*(1/metric1_total),
           metric11_lower_ci=(metric11_num_total-(sqrt(metric11_num_total*1.96)))*(1/metric1_total),
           metric12_upper_ci=(metric12_num_total+(sqrt(metric12_num_total*1.96)))*(1/metric1_total),
           metric12_lower_ci=(metric12_num_total-(sqrt(metric12_num_total*1.96)))*(1/metric1_total),
           metric13_upper_ci=(metric13_num_total+(sqrt(metric13_num_total*1.96)))*(1/metric1_total),
           metric13_lower_ci=(metric13_num_total-(sqrt(metric13_num_total*1.96)))*(1/metric1_total),
           metric14_upper_ci=(metric14_total+(sqrt(metric14_total*1.96)))*(1/metric1_total),
           metric14_lower_ci=(metric14_total-(sqrt(metric14_total*1.96)))*(1/metric1_total),
           metric15_upper_ci=(metric15_total+(sqrt(metric15_total*1.96)))*(1/metric1_total),
           ...
           metric19_lower_ci=(metric19_total-(sqrt(metric19_total*1.96)))*(1/metric1_total),
           metric20_upper_ci=(metric20_total+(sqrt(metric20_total*1.96)))*(1/metric1_total),
           metric20_lower_ci=(metric20_total-(sqrt(metric20_total*1.96)))*(1/metric1_total),
           metric21_upper_ci=(metric21_total+(sqrt(metric21_total*1.96)))*(1/metric1_total),
           metric21_lower_ci=(metric21_total-(sqrt(metric21_total*1.96)))*(1/metric1_total),
           metric22_upper_ci=(metric22_total+(sqrt(metric22_total*1.96)))*(1/metric1_total),
           metric22_lower_ci=(metric22_total-(sqrt(metric22_total*1.96)))*(1/metric1_total),
           metric23_upper_ci=(metric23_total+(sqrt(metric23_total*1.96)))*(1/metric1_total),
           metric23_lower_ci=(metric23_total-(sqrt(metric23_total*1.96)))*(1/metric1_total),
           metric24a_upper_ci=(metric24a_num_total+(sqrt(metric24a_num_total*1.96)))*(1/metric1_total),
           metric24a_lower_ci=(metric24a_num_total-(sqrt(metric24a_num_total*1.96)))*(1/metric1_total),
           metric24b_upper_ci=(metric24b_num_total+(sqrt(metric24b_num_total*1.96)))*(1/metric1_total),
           metric24b_lower_ci=(metric24b_num_total-(sqrt(metric24b_num_total*1.96)))*(1/metric1_total),
           metric25_upper_ci=(metric25_num_total+(sqrt(metric25_num_total*1.96)))*(1/metric1_total),
           metric25_lower_ci=(metric25_num_total-(sqrt(metric25_num_total*1.96)))*(1/metric1_total),
           metric26_upper_ci=(metric26_total+(sqrt(metric26_total*1.96)))*(1/metric1_total),
           metric26_lower_ci=(metric26_total-(sqrt(metric26_total*1.96)))*(1/metric1_total),
           metric27_upper_ci=(metric27_total+(sqrt(metric27_total*1.96)))*(1/metric1_total),
           metric27_lower_ci=(metric27_total-(sqrt(metric27_total*1.96)))*(1/metric1_total),
           metric28_upper_ci=(metric28_total+(sqrt(metric28_total*1.96)))*(1/metric1_total),
           metric28_lower_ci=(metric28_total-(sqrt(metric28_total*1.96)))*(1/metric1_total),
           metric28b_upper_ci=(metric28b_total+(sqrt(metric28b_total*1.96)))*(1/metric1_total),
           metric28b_lower_ci=(metric28b_total-(sqrt(metric28b_total*1.96)))*(1/metric1_total),
           metric29_upper_ci=(metric29_total+(sqrt(metric29_total*1.96)))*(1/metric1_total),
           metric29_lower_ci=(metric29_total-(sqrt(metric29_total*1.96)))*(1/metric1_total),
           metric29b_upper_ci=(metric29b_total+(sqrt(metric29b_total*1.96)))*(1/metric1_total),
           ...
           metric34_lower_ci=(metric34_num_total-(sqrt(metric34_num_total*1.96)))*(1/metric1_total),
           metric38_upper_ci=(metric38_num_total+(sqrt(metric38_num_total*1.96)))*(1/metric1_total),
           metric38_lower_ci=(metric38_num_total-(sqrt(metric38_num_total*1.96)))*(1/metric1_total),
           metric39_upper_ci=(metric39_num_total+(sqrt(metric39_num_total*1.96)))*(1/metric1_total),
           metric39_lower_ci=(metric39_num_total-(sqrt(metric39_num_total*1.96)))*(1/metric1_total),
           metric40_upper_ci=(metric40_num_total+(sqrt(metric40_num_total*1.96)))*(1/metric1_total),
           metric40_lower_ci=(metric40_num_total-(sqrt(metric40_num_total*1.96)))*(1/metric1_total)
    )
...
activity_by_type_clusters_stg3 <- activity_by_type_clusters_stg2|>
  mutate(metric2_overall_num_total=sum(metric2_num_total),
         ...
         metric2_upper_ci_global=(1/metric2_overall_denom_total)*((sqrt(metric2_overall_num_total)*1.96)+metric2_overall_num_total),
         metric2_lower_ci_global=(1/metric2_overall_denom_total)*((sqrt(metric2_overall_num_total)*1.96)-metric2_overall_num_total),
         ...
         metric5_upper_ci_global=(1/metric5_overall_denom_total)*((sqrt(metric5_overall_num_total)*1.96)+metric5_overall_num_total),
         metric5_lower_ci_global=(1/metric5_overall_denom_total)*((sqrt(metric5_overall_num_total)*1.96)-metric5_overall_num_total),
         ...
         metric6_upper_ci_global=(1/metric6_overall_denom_total)*((sqrt(metric6_overall_num_total)*1.96)+metric6_overall_num_total),
         metric6_lower_ci_global=(1/metric6_overall_denom_total)*((sqrt(metric6_overall_num_total)*1.96)-metric6_overall_num_total),
         ...
         metric7_upper_ci_global=(1/metric7_overall_denom_total)*((sqrt(metric7_overall_num_total)*1.96)+metric7_overall_num_total),
         metric7_lower_ci_global=(1/metric7_overall_denom_total)*((sqrt(metric7_overall_num_total)*1.96)-metric7_overall_num_total),
         ...
         metric8_upper_ci_global=(1/metric8_overall_denom_total)*((sqrt(metric8_overall_num_total)*1.96)+metric8_overall_num_total),
         metric8_lower_ci_global=(1/metric8_overall_denom_total)*((sqrt(metric8_overall_num_total)*1.96)-metric8_overall_num_total),      
         ...
         metric9_upper_ci_global=(1/metric9_overall_denom_total)*((sqrt(metric9_overall_num_total)*1.96)+metric9_overall_num_total),
         metric9_lower_ci_global=(1/metric9_overall_denom_total)*((sqrt(metric9_overall_num_total)*1.96)-metric9_overall_num_total),
         ...
         metric11_upper_ci_global=(1/metric11_overall_denom_total)*((sqrt(metric11_overall_num_total)*1.96)+metric11_overall_num_total),
         metric11_lower_ci_global=(1/metric11_overall_denom_total)*((sqrt(metric11_overall_num_total)*1.96)-metric11_overall_num_total),
         ...
         metric12_upper_ci_global=(1/metric12_overall_denom_total)*((sqrt(metric12_overall_num_total)*1.96)+metric12_overall_num_total),
         metric12_lower_ci_global=(1/metric12_overall_denom_total)*((sqrt(metric12_overall_num_total)*1.96)-metric12_overall_num_total),     
         ...
         metric13_upper_ci_global=(1/metric13_overall_denom_total)*((sqrt(metric13_overall_num_total)*1.96)+metric13_overall_num_total),
         metric13_lower_ci_global=(1/metric13_overall_denom_total)*((sqrt(metric13_overall_num_total)*1.96)-metric13_overall_num_total),
         ...
         metric14_upper_ci_global=(1/metric14_overall_denom_total)*((sqrt(metric14_overall_num_total)*1.96)+metric14_overall_num_total),
         metric14_lower_ci_global=(1/metric14_overall_denom_total)*((sqrt(metric14_overall_num_total)*1.96)-metric14_overall_num_total),
         ...
         metric15_upper_ci_global=(1/metric15_overall_denom_total)*((sqrt(metric15_overall_num_total)*1.96)+metric15_overall_num_total),
         metric15_lower_ci_global=(1/metric15_overall_denom_total)*((sqrt(metric15_overall_num_total)*1.96)-metric15_overall_num_total),
         ...
         metric18_upper_ci_global=(1/metric18_overall_denom_total)*((sqrt(metric18_overall_num_total)*1.96)+metric18_overall_num_total),
         metric18_lower_ci_global=(1/metric18_overall_denom_total)*((sqrt(metric18_overall_num_total)*1.96)-metric18_overall_num_total),
         ...
         metric19_upper_ci_global=(1/metric19_overall_denom_total)*((sqrt(metric19_overall_num_total)*1.96)+metric19_overall_num_total),
         metric19_lower_ci_global=(1/metric19_overall_denom_total)*((sqrt(metric19_overall_num_total)*1.96)-metric19_overall_num_total),
         ...
         metric20_upper_ci_global=(1/metric20_overall_denom_total)*((sqrt(metric20_overall_num_total)*1.96)+metric20_overall_num_total),
         metric20_lower_ci_global=(1/metric20_overall_denom_total)*((sqrt(metric20_overall_num_total)*1.96)-metric20_overall_num_total),
         ...
         metric21_upper_ci_global=(1/metric21_overall_denom_total)*((sqrt(metric21_overall_num_total)*1.96)+metric21_overall_num_total),
         metric21_lower_ci_global=(1/metric21_overall_denom_total)*((sqrt(metric21_overall_num_total)*1.96)-metric21_overall_num_total),
         ...
         metric22_upper_ci_global=(1/metric22_overall_denom_total)*((sqrt(metric22_overall_num_total)*1.96)+metric22_overall_num_total),
         metric22_lower_ci_global=(1/metric22_overall_denom_total)*((sqrt(metric22_overall_num_total)*1.96)-metric22_overall_num_total),
         ...
         metric23_upper_ci_global=(1/metric23_overall_denom_total)*((sqrt(metric23_overall_num_total)*1.96)+metric23_overall_num_total),
         metric23_lower_ci_global=(1/metric23_overall_denom_total)*((sqrt(metric23_overall_num_total)*1.96)-metric23_overall_num_total),
         
         metric24a_overall_num_total=sum(metric24a_num_total),
         metric24a_overall_denom_total=sum(metric1_total),
         metric24a_global_rate=metric24a_overall_num_total/metric24a_overall_denom_total,
         metric24a_upper_ci_global=(1/metric24a_overall_denom_total)*((sqrt(metric24a_overall_num_total)*1.96)+metric24a_overall_num_total),
         metric24a_lower_ci_global=(1/metric24a_overall_denom_total)*((sqrt(metric24a_overall_num_total)*1.96)-metric24a_overall_num_total),
         metric24b_overall_num_total=sum(metric24b_num_total),
         metric24b_overall_denom_total=sum(metric1_total),
         metric24b_global_rate=metric24b_overall_num_total/metric24b_overall_denom_total,
         metric24b_upper_ci_global=(1/metric24b_overall_denom_total)*((sqrt(metric24b_overall_num_total)*1.96)+metric24b_overall_num_total),
         metric24b_lower_ci_global=(1/metric24b_overall_denom_total)*((sqrt(metric24b_overall_num_total)*1.96)-metric24b_overall_num_total),
         ...
         metric25_upper_ci_global=(1/metric25_overall_denom_total)*((sqrt(metric25_overall_num_total)*1.96)+metric25_overall_num_total),
         metric25_lower_ci_global=(1/metric25_overall_denom_total)*((sqrt(metric25_overall_num_total)*1.96)-metric25_overall_num_total),
         ...
         metric26_upper_ci_global=(1/metric26_overall_denom_total)*((sqrt(metric26_overall_num_total)*1.96)+metric26_overall_num_total),
         metric26_lower_ci_global=(1/metric26_overall_denom_total)*((sqrt(metric26_overall_num_total)*1.96)-metric26_overall_num_total),
         ...
         metric27_upper_ci_global=(1/metric27_overall_denom_total)*((sqrt(metric27_overall_num_total)*1.96)+metric27_overall_num_total),
         metric27_lower_ci_global=(1/metric27_overall_denom_total)*((sqrt(metric27_overall_num_total)*1.96)-metric27_overall_num_total),
         ...
         metric28_upper_ci_global=(1/metric28_overall_denom_total)*((sqrt(metric28_overall_num_total)*1.96)+metric28_overall_num_total),
         metric28_lower_ci_global=(1/metric28_overall_denom_total)*((sqrt(metric28_overall_num_total)*1.96)-metric28_overall_num_total),
         ...
         metric28b_upper_ci_global=(1/metric28b_overall_denom_total)*((sqrt(metric28b_overall_num_total)*1.96)+metric28b_overall_num_total),
         metric28b_lower_ci_global=(1/metric28b_overall_denom_total)*((sqrt(metric28b_overall_num_total)*1.96)-metric28b_overall_num_total),
         ...
         metric29_upper_ci_global=(1/metric29_overall_denom_total)*((sqrt(metric29_overall_num_total)*1.96)+metric29_overall_num_total),
         metric29_lower_ci_global=(1/metric29_overall_denom_total)*((sqrt(metric29_overall_num_total)*1.96)-metric29_overall_num_total),
         ...
         metric29b_upper_ci_global=(1/metric29b_overall_denom_total)*((sqrt(metric29b_overall_num_total)*1.96)+metric29b_overall_num_total),
         metric29b_lower_ci_global=(1/metric29b_overall_denom_total)*((sqrt(metric29b_overall_num_total)*1.96)-metric29b_overall_num_total),
         ...
         metric33_upper_ci_global=(1/metric33_overall_denom_total)*((sqrt(metric33_overall_num_total)*1.96)+metric33_overall_num_total),
         metric33_lower_ci_global=(1/metric33_overall_denom_total)*((sqrt(metric33_overall_num_total)*1.96)-metric33_overall_num_total),
         ...
         metric34_upper_ci_global=(1/metric34_overall_denom_total)*((sqrt(metric34_overall_num_total)*1.96)+metric34_overall_num_total),
         metric34_lower_ci_global=(1/metric34_overall_denom_total)*((sqrt(metric34_overall_num_total)*1.96)-metric34_overall_num_total),
         ...
         metric38_upper_ci_global=(1/metric38_overall_denom_total)*((sqrt(metric38_overall_num_total)*1.96)+metric38_overall_num_total),
         metric38_lower_ci_global=(1/metric38_overall_denom_total)*((sqrt(metric38_overall_num_total)*1.96)-metric38_overall_num_total),
         ...
         metric39_upper_ci_global=(1/metric39_overall_denom_total)*((sqrt(metric39_overall_num_total)*1.96)+metric39_overall_num_total),
         metric39_lower_ci_global=(1/metric39_overall_denom_total)*((sqrt(metric39_overall_num_total)*1.96)-metric39_overall_num_total),
         ...
         metric40_upper_ci_global=(1/metric40_overall_denom_total)*((sqrt(metric40_overall_num_total)*1.96)+metric40_overall_num_total),
         metric40_lower_ci_global=(1/metric40_overall_denom_total)*((sqrt(metric40_overall_num_total)*1.96)-metric40_overall_num_total)
         )
...
calc_iod_diff_rate <-function(activity_by_type_clusters_stg3){
  activity_by_type_clusters_stg4 <- activity_by_type_clusters_stg3|>
    mutate(metric2_diff_rate=metric2_rate-metric2_global_rate,
           ...
           metric24a_diff_rate=metric24a_rate-metric24a_global_rate,
           metric24b_diff_rate=metric24b_rate-metric24b_global_rate,
           ...
           metric24a_abs_diff_rate=abs(metric24a_diff_rate),
           metric24b_abs_diff_rate=abs(metric24b_diff_rate),
...
calc_iod_diff <-function(activity_by_type_clusters_stg4){
  activity_by_type_clusters_stg5 <- activity_by_type_clusters_stg4|>
    mutate(metric2_diff=metric2_diff_rate*list_size_total,
           ...
           metric24a_diff=metric24a_diff_rate*metric1_total,
           metric24b_diff=metric24b_diff_rate*metric1_total,
           ...
           metric24a_abs_diff=abs(metric24a_diff),
           metric24b_abs_diff=abs(metric24b_diff),
...
calc_abs_iod <- function(activity_by_type_clusters_stg5){
  ...
  activity_by_type_clusters_stg6 <- activity_by_type_clusters_stg5 |>
    mutate(metric2_abs_iod=sum(metric2_abs_diff)/2,
           ...
           metric24a_abs_iod=sum(metric24a_abs_diff)/2,
           metric24b_abs_iod=sum(metric24b_abs_diff)/2,
           ...
           metric24a_rel_iod=(sum(metric24a_abs_diff)/(2*metric24a_overall_num_total))*100,
           metric24b_rel_iod=(sum(metric24b_abs_diff)/(2*metric24b_overall_num_total))*100,
