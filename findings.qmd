...
...to be determined - awaiting death data check
:::
...
The relative index of deprivation for the metric is expressed here as a %, such that the % indicates the amount of activity that would need to be redistributed between clusters in order that event rates follow levels of need. The detail of the methodology used for its calculation can be found in the appendix.
...
-   The greatest disparity is flu vaccinations for patients aged 65+ where the relative index of disparity is 16.70% (95% ci - 16.64%, 16.70%), indicating that 16.7% of activity needs to be redistributed so that rates reflect need.
:::
