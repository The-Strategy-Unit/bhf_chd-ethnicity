...
Table 3 shows that the most diverse cluster has the greatest proportion of patients in practices in the most deprived quantile. Cluster 2 has the greatest proportion of patients in practices in the least deprived quantile.

```{r}
source("R/get_imd_data_by_gpprac.R")

patientweighted_practice_imd |>
  mutate(gp_imd_quantile = case_when(gp_imd_decile<=2 ~ 1,
                                     gp_imd_decile==3 ~2,
                                     gp_imd_decile==4 ~2,
                                     gp_imd_decile==5 ~3,
                                     gp_imd_decile==6 ~3,
